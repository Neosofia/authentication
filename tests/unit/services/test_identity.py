...
def test_sync_identity_data_inserts(mock_db_session):
    ...
    assert tenant.changed_by_uuid.hex == "00000000000070008000000000000000"
    assert tenant.changed_by_type == 2
    assert user.changed_by_uuid.hex == "00000000000070008000000000000000"
    assert user.changed_by_type == 2
